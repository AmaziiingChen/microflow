...
urls = {
    ...
    # 。 #音乐学院
    "音乐学院-封面新闻": "https://musicyyds.sztu.edu.cn/zxdt/fmxw.htm",
    "音乐学院-学生事务": "https://musicyyds.sztu.edu.cn/zxdt/xssw.htm",
    "音乐学院-教研活动": "https://musicyyds.sztu.edu.cn/zxdt/jyhd.htm",
    # "音乐学院-媒体报道": "https://musicyyds.sztu.edu.cn/zxdt/mtbd.htm",
}
...
for name, url in urls.items():
    ...
    try:
        ...
        if next_btn:
            ...
            print(
                "❌ 警告：在这个网页的源码里，根本没有找到带有'下一页'文本的 a 标签！可能使用了 JS 动态加载。"
            )
